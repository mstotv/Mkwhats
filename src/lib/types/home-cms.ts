...
export interface HomeComparisonPoint {
  id: string
  title_ar: string
  title_en: string
  desc_ar: string
...
export interface HomeComparisonContent {
  ...
  subtitle_ar: string
  subtitle_en: string
  pain_points: HomeComparisonPoint[]
  solution_points: HomeComparisonPoint[]
}
...
export interface HomeRoiCalculatorContent {
  badge_ar: string
  badge_en: string
  title_ar: string
  title_en: string
...
export interface HomeMetricsProofContent {
  badge_ar: string
  badge_en: string
  title_ar: string
  title_en: string
...
export interface HomeContent {
  comparison: HomeComparisonContent
