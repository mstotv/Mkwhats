...
> 🚨 **قواعد معمارية ثابتة ودائمة لهيكلة صفحات الموقع (Page Architecture Rules - Strict):**
> 1. **الصفحة الرئيسية (`/` - `src/app/page.tsx`)**: مخصصة حصرياً للتعريف بالمنصة، طريقة عملها، ركائز القيمة، الإحصائيات، وآراء العملاء. **ممنوع منعاً باتاً إضافة جداول وباقات الأسعار (`LandingPricing`) إلى الصفحة الرئيسية**.
> 2. **صفحة الأسعار (`/pricing` - `src/app/pricing/page.tsx`)**: هي المكان الحصري والوحيد لعرض جداول الخطط والأسعار، تفاصيل الفوترة الشهرية/السنوية، وشارات الأيام المجانية التجريبية.
> 3. **صفحة المميزات (`/features` - `src/app/features/page.tsx`)**: هي المكان الحصري للتفصيل المعمق لكافة ميزات وأدوات المنصة.
